...
<body class="bg-light">
  <?php 
   ...
   <?php
    ...
    $sql = "UPDATE wishlist SET WLCategory='$category', WLWant='$want', WLMessage ='$message' WHERE WishListID = '$id'";
  ...
  <section class="col-sm-12 bg-light"> 
    <?php 
          $id = $_GET['id'];
          $res = mysqli_query($conn, "SELECT * FROM wishlist WHERE WishListID = '$id'");
