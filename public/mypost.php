   ...
   ?>
    ...
    <div class="container">
     ...
     ?> 
      ...
      <?php 
      $builder = $dom = null;
       $sql = "SELECT * FROM itemsell WHERE (accountid = '$id' && SItemStatus = '1')"; 
        ...
        while ($row = mysqli_fetch_assoc($result)){   
          ...
          <div class="block2">
            ...
            <div class="row justify-content-center py-3">
              <a href="updatepost.php?id='.$row['ItemSellID'].'"><button type="button" class="btn btn-success mr-2"
              onclick="confirm(\'Are you sure to edit ?\')">Edit</button></a>
              <a href="deactivatepost.php?del='.$row['ItemSellID'].'"><button type="button" class="btn btn-danger mr-2"
