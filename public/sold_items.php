    ...
    <div class="container">
      <div class="p-b-10">
        ...
        <div class="flex-w flex-c-m m-tb-10">
          ...
          <div class="ml-2">
            <a href="inactivepost.php" class="flex-c-m stext-106 cl6 size-105 bor4 pointer hov-btn3 trans-04 m-tb-4">Inactive Post</a>
          </div>
      ...
      <?php
           ...
           $dataAll = json_decode(pagination("itemsell","SItemStatus",2,"accountid","$id",$page,1,12,"ItemSellID","DESC",""),true);
