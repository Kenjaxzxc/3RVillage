...
<body class="bg-light">
  <?php 
    ...
    if(!empty($_GET['id'])){
      $id = $_GET['id'];
      $sql3 = "SELECT * FROM subscriptionhistory a, subscriptiontype b, subscribed c, account d WHERE a.subscriptiontype = b.subscriptionID and a.userid=d.accountid and a.userid='$id' Order by a.transactionStamp desc";
   ...
   <div class="container" style="margin-top: 110px;">
  	...
  	<div class="row">
        ...
        <h3 class="mb-4">Subscription List</h3>
